        ...
        const _events = [
            {
                ...
                date: "12.06.2024",
                editor: 'Александр',
                description: "Дорогие друзья и коллеги! Мы рады объявить о нашем следующем захватывающем мероприятии – \"Поездка в Крым\", которое состоится с 15 по 22 мая 2023 года. Приглашаем вас стать частью этого удивительного путешествия, где каждый день будет наполнен новыми впечатлениями и воспоминаниями, которые останутся с вами на всю жизнь.",
            },{
                _id: "qweqweqweqwe",
